...
namespace PCLActivitySet.Test.AutoFixtureCustomizations
{
    ...
    /// </summary>
    public class NonZeroEnumGenerator : ISpecimenBuilder
    {
        private readonly Dictionary<Type, IEnumerator> enumerators;
        private readonly object syncRoot;

        /// <summary>
        /// Initializes a new instance of the <see cref="NonZeroEnumGenerator"/> class.
        /// </summary>
        public NonZeroEnumGenerator()
        {
        ...
        public object Create(object request, ISpecimenContext context)
        {
            ...
            if (!NonZeroEnumGenerator.IsEnumType(t))
            {
...
#pragma warning restore 618
        ...
        private class RoundRobinEnumEnumerable : IEnumerable
        {
            ...
            internal RoundRobinEnumEnumerable(Type enumType)
            {
                ...
                this.values = Enum.GetValues(enumType).Cast<object>().Where(x => (int)x != 0);
